...
const ModalPhoto = (props) => {
    ...
    return (
        <>
            <img onClick={toggle} src={API_STATIC_MEDIA + props.task.photo} alt='loading' style={{height: 50}}/>
            <Modal isOpen={visible} toggle={toggle}>
                <ModalHeader  style={{color:"white",justifyContent: "center", backgroundColor:"#212529"}}>Фото</ModalHeader>
                <ModalBody style={{display:"flex", justifyContent:"center", backgroundColor:"#212529"}}><img src={API_STATIC_MEDIA + props.task.photo} alt="loading"/></ModalBody>
